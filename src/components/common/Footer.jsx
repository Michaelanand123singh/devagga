    ...
    <footer className="bg-dark-light text-white">
      <div className="container mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {/* Company Info */}
          <div>
            <h4 className="text-xl font-bold gradient-text mb-4">DevAgga</h4>
            <p className="mb-6 text-gray-300">Bringing imagination to life through creative animation solutions.</p>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300 space-y-2">
              <p>123 Animation Street</p>
              <p>Creative District, CA 12345</p>
              <p className="mt-4">Email: <a href="mailto:info@devagga.com" className="hover:text-primary-light transition-colors">info@devagga.com</a></p>
              <p>Phone: <a href="tel:+1234567890" className="hover:text-primary-light transition-colors">+1 (234) 567-890</a></p>
            </address>
          </div>
        </div>
        
        <div className="mt-12 pt-8 border-t border-gray-700 text-center text-gray-400">
          <p>&copy; {currentYear} DevAgga. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
