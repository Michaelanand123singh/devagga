...
const AboutUs = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      className="py-12 md:py-20 bg-dark-light relative overflow-hidden transition-all duration-500 ease-out"
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute -top-10 -left-10 w-32 md:w-64 h-32 md:h-64 rounded-full bg-primary-dark blur-3xl animate-pulse"></div>
        <div className="absolute bottom-10 right-10 w-48 md:w-96 h-48 md:h-96 rounded-full bg-primary blur-3xl animate-pulse" 
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <AnimatedSection animation="fadeRight" delay={0.2}>
            <div className="prose prose-md md:prose-lg prose-invert max-w-none">
          ...
          <AnimatedSection animation="fadeLeft" delay={0.4}>
            <div className="relative rounded-lg overflow-hidden shadow-xl h-64 md:h-96">
              ...
              <div className="absolute bottom-0 left-0 p-4 md:p-6">
                <h3 className="text-xl md:text-2xl font-bold mb-1 md:mb-2">Our Creative Team</h3>
                <p className="text-gray-300 text-sm md:text-base">Passionate storytellers and technical wizards</p>
              </div>
            </div>
          </AnimatedSection>
        </div>
